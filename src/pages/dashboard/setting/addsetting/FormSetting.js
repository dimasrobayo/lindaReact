        ...
        <form>
            <div className="card-body row">
                <div className="col-md-6">
                    ...
                    <div className="form-group">
                        <label htmlFor="exampleInput">CIUDAD</label>
                ...
                <div className="col-md-6">
                    ...
                    <div className="form-group">
                        <label htmlFor="exampleInput">DIRECCION</label>
